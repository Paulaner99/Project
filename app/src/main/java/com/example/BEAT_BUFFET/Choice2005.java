    ...
    public void onRadioButtonClicked1(View view) {
        ...
        switch (view.getId()) {
            case R.id.radio_1_0:
                if (checked)
                    // 0%
                    g1 = (float) (value_cash * 0 * (1 + 0.6640));
            ...
            case R.id.radio_1_1:
                if (checked)
                    // 25%
                    g1 = (float) (value_cash * 0.25 * (1 + 0.6640));
            ...
            case R.id.radio_1_2:
                if (checked)
                    // 50%
                    g1 = (float) (value_cash * 0.5 * (1 + 0.6640));
            ...
            case R.id.radio_1_3:
                if (checked)
                    // 75%
                    g1 = (float) (value_cash * 0.75 * (1 + 0.6640));
            ...
            case R.id.radio_1_4:
                if (checked)
                    // 100%
                    g1 = (float) (value_cash * 1 * (1 + 0.6640));
    ...
    public void onRadioButtonClicked2(View view) {
        ...
        switch (view.getId()) {
            case R.id.radio_2_0:
                if (checked)
                    // 0%
                    g2 = (float) (value_cash * 0 * (1 + 0.2181));
            ...
            case R.id.radio_2_1:
                if (checked)
                    // 25%
                    g2 = (float) (value_cash * 0.25 * (1 + 0.2181));
            ...
            case R.id.radio_2_2:
                if (checked)
                    // 50%
                    g2 = (float) (value_cash * 0.5 * (1 + 0.2181));
            ...
            case R.id.radio_2_3:
                if (checked)
                    // 75%
                    g2 = (float) (value_cash * 0.75 * (1 + 0.2181));
            ...
            case R.id.radio_2_4:
                if (checked)
                    // 100%
                    g2 = (float) (value_cash * 1 * (1 + 0.2181));
    ...
    public void onRadioButtonClicked3(View view) {
        ...
        switch (view.getId()) {
            case R.id.radio_3_0:
                if (checked)
                    // 0%
                    g3 = (float) (value_cash * 0 * (1 - 0.6071));
            ...
            case R.id.radio_3_1:
                if (checked)
                    // 25%
                    g3 = (float) (value_cash * 0.25 * (1 - 0.6071));
            ...
            case R.id.radio_3_2:
                if (checked)
                    // 50%
                    g3 = (float) (value_cash * 0.5 * (1 - 0.6071));
            ...
            case R.id.radio_3_3:
                if (checked)
                    // 75%
                    g3 = (float) (value_cash * 0.75 * (1 - 0.6071));
            ...
            case R.id.radio_3_4:
                if (checked)
                    // 100%
                    g3 = (float) (value_cash * 1 * (1 - 0.6071));
    ...
    public void onRadioButtonClicked4(View view) {
        ...
        switch (view.getId()) {
            case R.id.radio_4_0:
                if (checked)
                    // 0%
                    g4 = (float) (value_cash * 0 * (1 - 0.2087));
            ...
            case R.id.radio_4_1:
                if (checked)
                    // 25%
                    g4 = (float) (value_cash * 0.25 * (1 - 0.2087));
            ...
            case R.id.radio_4_2:
                if (checked)
                    // 50%
                    g4 = (float) (value_cash * 0.5 * (1 - 0.2087));
            ...
            case R.id.radio_4_3:
                if (checked)
                    // 75%
                    g4 = (float) (value_cash * 0.75 * (1 - 0.2087));
            ...
            case R.id.radio_4_4:
                if (checked)
                    // 100%
                    g4 = (float) (value_cash * 1 * (1 - 0.2087));
