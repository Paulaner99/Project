    ...
    public void onRadioButtonClicked1(View view) {
        ...
        switch(view.getId()) {
            case R.id.radio_1_0:
                if (checked)
                    // 0%
                    guadagno = guadagno + value_cash * 0 * (1 - 0.2337);
    ...
    public void onRadioButtonClicked2(View view) {
        ...
        switch(view.getId()) {
            case R.id.radio_2_0:
                if (checked)
                    // 0%
                    guadagno = guadagno + value_cash * 0 * (1 - 0.6500);
                    cash = cash - value_cash * 0;
                break;
            case R.id.radio_2_1:
                if (checked)
                    // 25%
                    guadagno = guadagno + value_cash * 0.25 * (1 - 0.6500);
                    cash = cash - value_cash * 0.25;
                break;
            case R.id.radio_2_2:
                if (checked)
                    // 50%
                    guadagno = guadagno + value_cash * 0.5 * (1 - 0.6500);
                    cash = cash - value_cash * 0.5;
                break;
            case R.id.radio_2_3:
                if (checked)
                    // 75%
                    guadagno = guadagno + value_cash * 0.75 * (1 - 0.6500);
                    cash = cash - value_cash * 0.75;
                break;
            case R.id.radio_2_4:
                if (checked)
                    // 100%
                    guadagno = guadagno + value_cash * 1 * (1 - 0.6500);
                    cash = cash - value_cash * 1;
                break;
        }
    }
    ...
    public void onRadioButtonClicked3(View view) {
        ...
        switch(view.getId()) {
            case R.id.radio_3_0:
                if (checked)
                    // 0%
                    guadagno = guadagno + value_cash * 0 * (1 + 0.9574);
                cash = cash - value_cash * 0;
                break;
            case R.id.radio_3_1:
                if (checked)
                    // 25%
                    guadagno = guadagno + value_cash * 0.25 * (1 + 0.9574);
                    cash = cash - value_cash * 0.25;
                break;
            case R.id.radio_3_2:
                if (checked)
                    // 50%
                    guadagno = guadagno + value_cash * 0.5 * (1 + 0.9574);
                    cash = cash - value_cash * 0.5;
                break;
            case R.id.radio_3_3:
                if (checked)
                    // 75%
                    guadagno = guadagno + value_cash * 0.75 * (1 + 0.9574);
                    cash = cash - value_cash * 0.75;
                break;
            case R.id.radio_3_4:
                if (checked)
                    // 100%
                    guadagno = guadagno + value_cash * 1 * (1 + 0.9574);
                    cash = cash - value_cash * 1;
                break;
        }
    }
    ...
    public void onRadioButtonClicked4(View view) {
        ...
        switch(view.getId()) {
            case R.id.radio_4_0:
                if (checked)
                    // 0%
                    guadagno = guadagno + value_cash * 0 * (1 + 0.2896);
                    cash = cash - value_cash * 0;
                break;
            case R.id.radio_4_1:
                if (checked)
                    // 25%
                    guadagno = guadagno + value_cash * 0.25 * (1 + 0.2896);
                    cash = cash - value_cash * 0.25;
                break;
            case R.id.radio_4_2:
                if (checked)
                    // 50%
                    guadagno = guadagno + value_cash * 0.5 * (1 + 0.2896);
                    cash = cash - value_cash * 0.5;
                break;
            case R.id.radio_4_3:
                if (checked)
                    // 75%
                    guadagno = guadagno + value_cash * 0.75 * (1 + 0.2896);
                    cash = cash - value_cash * 0.75;
                break;
            case R.id.radio_4_4:
                if (checked)
                    // 100%
                    guadagno = guadagno + value_cash * 1 * (1 + 0.2896);
                    cash = cash - value_cash * 1;
                break;
        }
    }
